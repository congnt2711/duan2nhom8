...
//        if (pos % 2 == 0) vh.itemView.startAnimation(AnimationUtils.loadAnimation(context, R.anim.slide_in_right))
//        else vh.itemView.startAnimation(AnimationUtils.loadAnimation(context, R.anim.slide_in_left))
